...
public class Locators1 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		String errorText = driver.findElement(By.cssSelector("p.error")).getText(); // Using css selector with tagName.className
		System.out.println(errorText);

		driver.findElement(By.linkText("Forgot your password?")).click(); // Using the locator linkText
		driver.findElement(By.xpath("//input[@placeholder='Name']")).sendKeys("Aravind Juloori");  //Using the locator Xpath
		driver.findElement(By.cssSelector("input[placeholder='Email']")).sendKeys("aravind.juloori@gmail.com");  //using css selector
//		Thread.sleep(2000);
		driver.findElement(By.xpath("//input[@type='text'][2]")).clear();  //using xpath with the indexing concept
		driver.findElement(By.cssSelector("input[type='text']:nth-child(3)")).sendKeys("john@gmail.com"); //using css selector with indexing concept
		...
		driver.findElement(By.xpath("//div[@class='forgot-pwd-btn-conainer']/button[1]")).click();  //xpath with parent/child tagid
		Thread.sleep(1000);
